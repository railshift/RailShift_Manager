...
class _AlertManagementScreenState extends State<AlertManagementScreen> with TickerProviderStateMixin {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => AnimatedContainer(
                    ...
                    child: _buildEnhancedAlertCard(filteredAlerts[index], index),
                  ),
                ),
              ),
          ],
      ...
      itemBuilder: (context, index) {
        ...
        return Column(
          ...
          children: [
            ...
            ...shiftAlerts.asMap().entries.map((entry) => AnimatedContainer(
              duration: Duration(milliseconds: 300 + (entry.key * 100)),
              curve: Curves.easeOutCubic,
              child: _buildEnhancedAlertCard(entry.value, entry.key),
            )),
          ],
        );
      },
  ...
  Widget _buildEnhancedAlertCard(Alert alert, int index) {
    final isDarkMode = Theme.of(context).brightness == Brightness.dark;
      ...
      child: Material(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
              color: getAlertColor().withOpacity(0.3),
              width: 1.5,
            ),
            boxShadow: [
              BoxShadow(
          ...
          child: InkWell(
            onTap: () => _showEnhancedAlertDetails(alert),
            borderRadius: BorderRadius.circular(20),
            child: Padding(
              padding: const EdgeInsets.all(20),
              child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(20),
                                    border: Border.all(color: getStatusColor(), width: 1.5),
                                  ),
                                  child: Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
